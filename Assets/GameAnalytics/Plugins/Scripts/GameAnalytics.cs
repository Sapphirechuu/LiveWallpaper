...
# endif
        ...
        public static string WhereIs(string _file)
        {
            ...
            return "";
#else
            string[] assets = { System.IO.Path.DirectorySeparatorChar + "Assets" + System.IO.Path.DirectorySeparatorChar};
            ...
            return "Assets" + System.IO.Path.DirectorySeparatorChar + temp [1];
